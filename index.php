...
<div id="school_header">
  <div id="site_title"> <a href="#"><img src="images/school_logo.png" /> NAME OF SCHOOL</a> </div>
  <!-- end of site_title -->
...
if (b==null || b=="")
  ...
  return false;
    ...
    <!-- if closes here -->
  </div><img src="images/school.png" width="260" height="250" style="margin:30px; border-radius:5px; border:3px double #FF9966;">
  <div class="cleaner"></div>
</div>
<!-- end of main -->
