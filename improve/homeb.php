        ...
        <ul>
          ...
          <li><a href="?action=viewpay">view</a>
            <ul>
              ...
              <li><a href='?action=onbursary'> studets on bursary</a></li>
    ...
    <div id="school_main">
	  ...
	  <br/></br>
        ...
        <div id="slider-wrapper">
          ...
          <div id="htmlcaption" class="nivo-html-caption"> Phone Doctors Uganda will <a href="#">fix it </a> for you. </div>
        </div>
          ...
          <form action="" method="post" >
            <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
              ...
              <tr>
                <td>Amount(total)</td>
                <td>&nbsp;</td>
                <td><input type="text" name="amount" size="30" id='in' maxlength="6" required /></td>
              </tr>
              <tr>
                <td>date</td>
                <td>&nbsp;</td>
...
$ins= mysql_query("INSERT INTO  itempay VALUES ('','$fnames','$item',$amount,'$date')") or die ('Some little problem: Amount should be int, tr again');
...
echo '<table style="width:100%">';
echo '<th align=left>Student</th><th align=left>CLASS</th><th align=left>SEX</th><th align=left>AMOUNT PAID</th>';
$flag = 0;
while($fetch=mysql_fetch_array($sel)){
...
echo '<table style="width:100%">';
echo '<th align=left>TERM</th><th align=left>YEAR</th><th align=left>TUTION</th><th align=left>T/L AMOUNT</th><th align=left>T/L DUES</th>';
...
$sel=mysql_query("SELECT * FROM itempay");
echo '<table style="width:100%">';
echo '<th align=left>Student</th><th align=left>item(s)paid for</th><th align=left>Amount</th><th align=left>Date</th>';
$flag = 0;
while($fetch=mysql_fetch_array($sel)){
