    ...
    <div id="school_menubar">
      <div id="top_nav" class="ddsmoothmenu">
        <ul>
          ...
          <li><a href="#">Record</a>
            <ul>
              <li><a href='homeb.ph?action=pay'> student pay</a></li>
            </ul>
          </li>
...
$fetch=mysql_fetch_array($sel)
 ...
 ?>
          <table border="1"cellpadding="0"  cellspacing="0" style="width:70%">
            <tr>
              <td height="63" colspan="3"  >student copy
                <center>
                  <font size="+1" style="letter-spacing:5px; font-weight:900;"> KISORO VISION S.S<br>
                  </font><font size="+0" style="letter-spacing:0px;"> P.O BOX 302, Kisoro-Uganda<br>
                  Tel:0772- 690233. 0772- 675300
                  <hr>
                  OFFICIAL COPY </font>
                </center></td>
            </tr>
            ...
            <tr>
              <td height="46" colspan="3" align="center"><p>Goods once sold are not returnable</p></td>
            </tr>
          </table>
          <?php
 if($action=='search'){//------------------------------------------------------------
