      ...
      <div id="top_nav" class="ddsmoothmenu">
        <ul>
          ...
          <li><a href="#">Register</a>
            <ul>
              <li><a href='?action=student'> Students</a></li>
            </ul>
          </li>
          <li><a href="?action=recordstudent">View students</a></li>
          <li><a href="?action=upload">upload student photo</a></li>
        </ul>
      </div>
          ...
          <form action="?action=registered" method="post" name="myform">
            <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
              <tr>
                ...
                <td >&nbsp;</td>
                <td ><input type="text" name="fname" size="30" id='in'title="enter you first name here" required></td>
              </tr>
              <tr>
                <td>sex</td>
                <td>&nbsp;</td>
	 ...
	 $op.="<option value=".$t.">".$t."</option>";
	  ...
	  ?>
              ...
              <tr>
                <td>district</td>
                <td>&nbsp;</td>
                <td><input type="text" name="dis" size="30" id='in'title="you district here" required /></td>
              </tr>
              <tr>
                <td>parent/g</td>
                <td>&nbsp;</td>
                <td><input type="text" name="pname" size="30" id='in'title="parents name here" required /></td>
              </tr>
              <tr>
                <td>day/bording</td>
                <td>&nbsp;</td>
...
echo '<th>NAMES</th><th>SEX</th><th>DISTRICT</th><th>PARENT</th><th>OFFERTYPE</th><th>CLASS</th><th>STATUS</th><th colspan=1>ACTION</th>';
