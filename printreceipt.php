    ...
    <div id="school_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
				<ul>
						...
						<li><a href="#">Record</a>
								<ul>
										<li><a href='?action=pay'> student pay</a></li>
										
								</ul>
						</li>
						<li><a href="?action=viewpay">view student pay</a></li>
...
{ 
  ...
  var docprint=window.open("","",disp_setting); 
   ...
   docprint.document.write('<html><head><title>school name powered printer</title>'); 
...
$fetch=mysql_fetch_array($sel)
 ...
 <tr><td height="63" colspan="3"  >student copy  
   <center>
     <font size="+1" style="letter-spacing:5px; font-weight:900;"> 
	 KISORO VISION S.S<br></font><font size="+0" style="letter-spacing:0px;"> 
	 	P.O BOX 302, Kisoro-Uganda<br>
		Tel:0772- 690233. 0772- 675300<hr>
   ...
   <tr>
     ...
     <td >&nbsp;</td>
     <td >date paid: <?php   echo ''.$fetch['9'].''      ?></td>
   </tr>
   <tr>
     <td>student  no. <?php  echo ''.$fetch['0'].'' ?></td>
     <td>&nbsp;</td>
     <td>&nbsp;</td>
   </tr>
   <tr>
     <td>student name: <?php  echo ''.$fetch['1'] ?></td>
     <td>&nbsp;</td>
     <td>academic year : <?php  echo ''.$fetch['4'].'' ?></td>
   </tr>
   <tr>
     <td>class: <?php  echo ''.$fetch['2'].'' ?></td>
     <td>&nbsp;</td>
     <td>term: <?php  echo ''.$fetch['3'].'' ?></td>
   </tr>
   <tr>
     <td>&nbsp;</td>
     <td>&nbsp;</td>
   ...
   <tr>
     ...
     <td>tution fee : <?php  echo ''.$fetch['5'].'' ?></td>
     <td>amount due : <?php  echo ''.$fetch['7'].'' ?></td>
   </tr>
   <tr>
     <td>amount paid : <?php  echo ''.$fetch['6'].'' ?> </td>
     <td>balance: <?php  echo ''.$fetch['8'].'' ?></td>
     <td>&nbsp;</td>
   </tr>
   ...
   <tr>
     <td colspan="3"  align="center"><i><hr>parents and guardians are to note that they have only two payments plans to settle fees in full<hr/></i></td>
   ...
   <tr>
     ...
     <td>&nbsp;</td>
     <td rowspan="2">this data was printed on:<br/> <?php
   ...
   <tr>
     <td height="46" colspan="3" align="center"><p>Goods once sold are not returnable</p>
       </td>
