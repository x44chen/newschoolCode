...
<div id="school_body_wrapper">
  <div id="school_wrapper">
        ...
        <ul>
          ...
          <li><a href="#">Update</a>
            <ul>
              ...
              <li><a href='?action=bursary'>stud. on bursary</a></li>
            </ul>
          </li>
          <li><a href="#">View records</a>
            <ul>
              <li><a href='?action=recordstudent'>students </a></li>
              <li><a href='?action=onbursary'>students on bursary </a></li>
			  ...
			  <li><a href='?action=trans'>student transcript</a></li>

              <li><a href='?action=viewpay'>Student pay</a></li>
              <li><a href='?action=unpaid'>unpaid students</a></li>
            </ul>
          </li>
    ...
    <div id="school_main">
      ...
      <div id="content" class="float_l"> <br/>
        ...
        <div id="slider-wrapper">
          <div id="slider" class="nivoSlider"> <img src="images/slider/bg1.jpg" alt="image" width="680" title="photo 1"  /> <a href="#"><img src="images/slider/bg2.jpg" alt="" width="680" title="photo 2" /></a> <img src="images/slider/bg3.jpg" alt="image" width="680" title="photo 3" /> <img src="images/slider/bg4.jpg" alt="image" width="680" title="photo 4" /> <img src="images/slider/bg5.jpg" alt="image" width="680" title="photo 5" title="##htmlcaption"   /> <img src="images/slider/bg6.jpg" alt="image" width="680" title="photo 6" /> <img src="images/slider/bg7.jpg" alt="image" width="680" title="photo 7" /> </div>
        </div>
      ...
      <div class="product_box"> LITERATURE HERE
        <?php }
        ...
        <form action="?action=registered1" method="post" name="myform">
          <table  border="0" cellspacing="3" cellpadding="5"  id='mytable'summary="registering student">
            ...
            <tr>
              <td>Qualification</td>
              <td>&nbsp;</td>
              <td><input type="text" name="quality" size="30" id='in'title="" required/></td>
            </tr>
            <tr>
              <td>salary</td>
              <td>&nbsp;</td>
    ...
    <?php 
			...
			echo '<th>NAME</th><th>SEX</th><th>DISTRICT</th><th>PARENT</th><th>OFFERTYPE</th><th>CLASS</th><th>STATUS</th><th colspan=2>ACTION</th>';
			
			while($fetch=mysql_fetch_array($sel)){
			
			
			echo '<tr><td>'.$fetch['1'].'</td><td>'.$fetch['SEX'].'</td><td>'.$fetch['DISTRICT'].'</td><td>'.$fetch['GUARDIAN'].'</td><td>'.$fetch['OFFERING'].'</td><td>'.$fetch['CLASS'].'</td><td>'.$fetch['STATUS'].'<td><a href=modifyst.php?id='.$fetch['STUDENT_ID'].'><img src="images/edit-icon.png" width=30 height=30 title=MODIFY_RECORD /></a></td><td><a href=deletest.php?id='.$fetch['STUDENT_ID'].'><img src="images/deletee.png" width="30" height="30" title=DELETE_RECORD /></a></td></tr>';
  ...
  <?php
			...
			echo '<table style="width:100%;">';
			echo '<th>NAMES</th><th>SEX</th><th>AGE</th><th>QUALIFICATION</th><th>STATUS</th><th colspan=2>ACTION</th>';
			$rowcolor=0;
...
<?php
			...
			echo '<table style="width:100%">';
			echo '<th align=left>Student</th><th align=left>CLASS</th><th align=left>SEX</th><th align=left>AMOUNT PAID</th><th align="left">ACTION</th>';
			$flag = 0;
			while($fetch=mysql_fetch_array($sel)){
...
<form action="" method="post" name="clubform" onSubmit="MM_validateForm('clubcode','','R','clubname','','R','description','','R','chairman','','R','patron','','R');return document.MM_returnValue">
  <table  id="mytable">
    ...
    <tr>
      <td>chairman</td>
      <td><input type="text" name="chairman" id='in'/></td>
    </tr>
    <tr>
      <td>ptron</td>
      <td><input type="text" name="patron" id='in'/></td>
    </tr>
    <tr>
      <td></td>
...
<?php
			...
			echo '<table style="width:100%">';
			echo '<th align="left">DAY REGISTERED</th><th align="left">NAME</th><th align="left">SEX</th><th align="left">CLUB NAME</th>';
			$flag = 0;
			while($fetch=mysql_fetch_array($sel)){
